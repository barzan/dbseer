...
init_pred_configs;
    ...
    maxTPJob = struct('taskName', 'MaxThrouputPrediction', 'lock_conf', test_config.lock_conf, 'io_conf', test_config.io_conf, 'workloadName', 'TPCC', 'resultsFile', 'maxThroughput.txt', 'appendToFile', false);
    ...
    maxTPJob = struct('taskName', 'MaxThrouputPrediction', 'lock_conf', test_config.lock_conf, 'io_conf', test_config.io_conf, 'workloadName', 'TPCC', 'resultsFile', 'maxThroughput.txt', 'appendToFile', true);
