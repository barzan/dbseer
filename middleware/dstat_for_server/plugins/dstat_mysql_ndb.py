...
class dstat_plugin(dstat):
    ...
    def __init__(self):
        self.name = 'mysql-ndb on ' + mysql_host +' ' + mysql_port
       	self.nick = ("Data memory", "Index memory", "REDO", "ndbnodecount", "DATA_MEMORY", "DISK_OPERATIONS", "DISK_RECORDS", "FILE_BUFFERS", "JOBBUFFER", "RESERVED", "TRANSPORT_BUFFERS")
       	self.vars = ("Data memory", "Index memory", "REDO", "ndbnodecount", "DATA_MEMORY", "DISK_OPERATIONS", "DISK_RECORDS", "FILE_BUFFERS", "JOBBUFFER", "RESERVED", "TRANSPORT_BUFFERS")
